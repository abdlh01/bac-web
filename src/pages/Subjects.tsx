...
const Subjects = () => {
  ...
  const subjects = [
    ...
    { name: "الكيمياء", icon: Atom, color: "bg-green-600", available: false },
    ...
    { name: "التربية الإسلامية", icon: BookOpen, color: "bg-teal-600", available: false },
    { name: "الفلسفة", icon: BookOpen, color: "bg-violet-600", available: false },
    { name: "التربية الفنية", icon: Palette, color: "bg-orange-600", available: false },
    { name: "التربية الموسيقية", icon: Music, color: "bg-rose-600", available: false },
    { name: "التربية البدنية", icon: Dumbbell, color: "bg-slate-600", available: false },
    { name: "التكنولوجيا", icon: Briefcase, color: "bg-gray-600", available: false },
  ];
